...
export class initial1645167790939 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`candidate\` ADD CONSTRAINT \`FK_01e0d963db31f953b94d0446e17\` FOREIGN KEY (\`pollId\`) REFERENCES \`poll\`(\`id\`) ON DELETE NO ACTION`);
        // ON UPDATE NO ACTION    if any error comes in tabel add this line to upper query
    }
